...
class ViewController: UIViewController,DMenuViewDelegate,DMenuViewDataSource {
  ...
  var areas = [["华语","敢死队1","敢死队2","敢死队3","敢死队4","敢死队1","敢死队2","敢死队3","敢死队4"],["香港地区","李小龙1","李小龙2","李小龙3","李小龙1","李小龙2","李小龙3"],["美国","极限特工1","极限特工2","极限特工3","极限特工4"],["欧洲","极限特工1","极限特工2","极限特工3","极限特工4","极限特工1","极限特工2","极限特工3","极限特工4"],["韩国","极限特工1","极限特工2","极限特工3","极限特工4"],["日本","测试数据1","测试数据2","测试数据3","测试数据4","测试数据1","测试数据2","测试数据3","测试数据4","测试数据1","测试数据2","测试数据3","测试数据4","测试数据1","测试数据2","测试数据3","测试数据4","测试数据1","测试数据2","测试数据3","测试数据4","测试数据1","测试数据2","测试数据3","测试数据4"]]
